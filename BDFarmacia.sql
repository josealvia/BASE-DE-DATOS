...
/*insetar proveedor*/
insert into proveedores values(1,'Distribuidora Difarmes','Quito','052389546');
insert into proveedores values(2,'Distribuidora Farmaceutica El punto Verde','Guayaquil','04 239-9683');
insert into proveedores values(3,'Distribuidora Farmaceutica Disfor S.A','Guayaquil','02373-1390');
insert into proveedores values(4,'Cedimed Cia Ltda ','Quito','02256-0170');
...
insert into detalle_de_venta values(15,1,10,0.20,1,0.0,'20/10/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=1;
...
insert into detalle_de_venta values(8,1,7,0.48,2,0.0,'25/11/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=2;
...
insert into detalle_de_venta values(5,4,8,0.20,4,0.0,'26/11/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=4;
...
insert into detalle_de_venta values(13,5,4,0.48,5,0.0,'30/11/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=5;
...
insert into detalle_de_venta values(16,6,7,0.50,6,0.0,'10/12/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=6;
...
insert into detalle_de_venta values(1,7,6,0.50,7,0.0,'5/12/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=7;
...
insert into detalle_de_venta values(4,8,7,0.45,8,0.0);
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=8;
...
insert into detalle_de_venta values(12,9,20,0.49,9,0.0,'10/12/2020');
update detalle_de_venta set total_detalle=cantidad_producto*precio_producto where id_detalle_venta=9;
...
select productos.nombre_producto, detalle_de_venta.cantidad_producto, 
count(detalle_de_venta.cantidad_producto) from ventas 
inner join detalle_de_venta on ventas.id_ventas=detalle_de_venta.id_ventas
inner join productos on productos.codigo_producto=detalle_de_venta.codigo_producto 
inner join vendedor on vendedor.codigo_vendedor = ventas.codigo_vendedor
inner join sucursales on sucursales.codigo_sucursal = vendedor.codigo_sucursal
where sucursales.codigo_sucursal=1
group by productos.nombre_producto , detalle_de_venta.cantidad_producto
order by detalle_de_venta.cantidad_producto desc
limit 1;
